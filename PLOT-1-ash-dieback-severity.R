...
########################################################
## INPUT DATA:
##   '../0_data/Ash-dieback-2022-121422.csv' - observation of dieback of ash canopy 
##
########################################################
"
rm(list = ls())
...
#import data------------------
dat <- read.csv("../0_data/Ash-dieback-2022-121422.csv") %>% rename(Value = colnames(.)[4])
...
ggplot(dat, aes(x = Site, y = Value, fill = Plot)) +
  ...
  labs(x = "Site", y = "Dieback of ash canopy (%)", fill = "Plot") +
